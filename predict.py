def predict(inp, modeldir,csvdir,txtdir, wew):
    import pandas as pd
    import numpy as np
    import os
    import time
    ...
    text = open(txtdir, 'rb').read().decode(encoding='utf-8')
    ...
    def make_lyrics(seed_text, next_words):
        for _ in range(next_words):
            ...
            token_list = pad_sequences([token_list],maxlen=max_sequence_len - wew ,padding='pre')
